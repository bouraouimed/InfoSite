...
$retour_total=mysql_query('SELECT COUNT(*) AS total FROM article where idcat= 2'); //Nous récupérons le contenu de la requête dans $retour_total
...
$sql = 'SELECT  id,title, content, picture , date,comment_count  FROM article where idcat= 2  ORDER BY date DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'';
...
if ($nb_news == 0) {
	...
	echo '<div class="post-title" lang="ar">
