...
;(function($){
	...
	sf.c = {
		bcClass     : 'dl-breadcrumb',
		menuClass   : 'dl-js-enabled',
		anchorClass : 'dl-with-ul',
		arrowClass  : 'dl-sub-indicator',
		shadowClass : 'dl-shadow'
	};
	sf.defaults = {
		hoverClass	: 'dlHover',
		...
		_initEvents : function() {
			...
			this.$menuitems.on( 'click.dlmenu', function( event ) {
				...
				var $item = $(this),
					...
					$serchbox = $item.children( '.responsive-searchbox' );
				if( $submenu.length > 0 ) {
				...
				}else if($(this).hasClass("dl-search")){
					
					if(!$(this).hasClass("s_on"))
					{
						$(this).addClass("s_on");
						$serchbox.children(".search-query").focus();
						$serchbox.children(".responsive-searchbox").css("background","#cecece");
					}
					return true;
				}else {
