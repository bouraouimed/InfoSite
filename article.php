...
$sql = "SELECT  title, content, picture , date,comment_count,idcat  FROM article where id= '$p';";
...
if ($nb_news == 0) {
	...
	echo '<div class="post-content" dir="rtl">'.$data['content'].'</div>';
