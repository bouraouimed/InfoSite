	...
	<body>
		...
		<section>
			...
			<div class="pageheader">
				<h2><i class="fa fa-table"></i>Liste des administrateurs</h2>
			</div>
...
$sql = 'SELECT  id,username,password,email FROM admin ORDER BY id ;';
...
if ($nb_news == 0) {
	echo '<td colspan="4"><center><p>aucun Admin trouvé</p><center></td>';
}
else {
